...
public class JuegoAhorcado {
  ...
  private static void jugar() {
    ...
    char[] progreso = inicializarProgreso(palabraSecreta); // Aray de chars
  ...
  /**
   * Representación del tamaño de la palabra real, oculta 
   * entre guiones.
   * @param palabra
  ...
  /**
   * Si usa una sola letra o no
   * @param entrada Letra que se emplea
   * @param usadas Letras usadas
   * @return Sí o No
   */
  private static boolean esIntentoLetraValida(String entrada, Set<Character> usadas) {
    return entrada.length() == 1 && Character.isLetter(entrada.charAt(0)) && !usadas.contains(entrada.charAt(0));
  }
